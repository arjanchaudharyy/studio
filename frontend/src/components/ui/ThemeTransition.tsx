            ...
            <div className="relative flex flex-col items-center justify-center gap-4">
                <div className="relative w-24 h-24 flex items-center justify-center">
                    ...
                    <Moon className={cn(
                        ...
                        displayTheme === 'dark' ? "scale-100 rotate-0 opacity-100" : "scale-50 -rotate-90 opacity-0"
                    )} strokeWidth={1.5} />
                </div>
                ...
                <div className="h-8 relative overflow-hidden flex flex-col items-center min-w-[200px]">
                    <span className={cn(
                        ...
                        displayTheme === 'light' ? "translate-y-0 opacity-100 text-slate-950" : "-translate-y-8 opacity-0"
                    )}>
                        Light Mode
                    </span>
                    <span className={cn(
                        "text-xl font-medium tracking-widest uppercase transition-all duration-500 transform absolute whitespace-nowrap",
                        displayTheme === 'dark' ? "translate-y-0 opacity-100 text-white" : "translate-y-8 opacity-0"
                    )}>
                        Dark Mode
                    </span>
                </div>
