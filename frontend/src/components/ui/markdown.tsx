...
const md = new MarkdownIt({
  ...
  .use(markdownItLinkAttributes, {
    matcher(href: string) {
      ...
      return href.startsWith('http') && !href.includes('youtube.com') && !href.includes('vimeo.com')
    },
    attrs: {
      target: '_blank',
...
function arePropsEqual(prevProps: MarkdownViewProps, nextProps: MarkdownViewProps): boolean {
  ...
  const equal = prevProps.content === nextProps.content &&
...
export const MarkdownView = memo(function MarkdownView({ content, className, dataTestId, onEdit }: MarkdownViewProps) {
