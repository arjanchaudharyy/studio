...
const definition = defineComponent({
  ...
  docs: 'Writes the provided text content to an artifact using the configured file name and destinations. Useful for testing the artifact pipeline or persisting lightweight diagnostics.',
  ui: {
    ...
    category: 'output',
    description:
      'Save arbitrary text content as an artifact for the current run and/or the shared library.',
    icon: 'Archive',
    author: {
      name: 'ShipSecAI',
      type: 'shipsecai',
