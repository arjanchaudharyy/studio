...
<Steps>
  <Step title="Create a new workflow">
    Click **New Workflow** in the dashboard. Name it "DNS Recon" with description "Basic DNS enumeration".
  </Step>
  
  <Step title="Add components">
    - Drag **Manual Trigger** to the canvas
    - Drag **DNSX** component to the canvas
    - Connect the trigger output to the DNSX input
  </Step>
  
  <Step title="Configure DNSX">
    Click the DNSX component and set the domains input to `["example.com"]`.
  </Step>
