...
ShipSec Studio is a component-based security workflow orchestration platform designed for security teams to build, execute, and monitor reconnaissance workflows.
