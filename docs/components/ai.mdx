...
```
Nuclei → OpenAI Chat → Jira (Webhook)
```
...
<Note>
  **API Key Security**: Always use the Secret Loader component to inject API keys. Never hardcode credentials in prompts.
</Note>
...
| Gemini 1.5 Pro | 1M | 8192 |
| Gemini 2.0 Flash | 1M | 8192 |
